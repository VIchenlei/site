...
$(window).bind('load', function () {
  ...
  $('.spn_hol').fadeOut(300) // default to be 1000
})
...
$(function () {
  ...
  $('a[href*=#]:not([href=#], [href=#HANGYE], [href=#GONGSI], [href=#QUANBU])').click(function () {
...
$(document).ready(function () {
  ...
  $('#mc-form').ajaxChimp({
    ...
    url: 'https://beijingyongan.com/subscribe/post?u=f04c804868966b1b4509daa9b&amp;id=ad7b6aba65'
  })
...
$(document).ready(function () {
  ...
  var scrollAnimationTime = 600, // defualt is : 1200
...
function show(show, IDname){
  var div = document.getElementById(IDname);
  div.scrollTop = show * 320;
  return false;
}